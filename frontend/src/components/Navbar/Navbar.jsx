    ...
    !isHidden && (
      <div className="menubar-area">
        <div className="toolbar-inner menubar-nav">
          ...
          >
            ...
            >
              <path
                ...
                // style={{ fill: location.pathname === "" ? "#fe9063" : "" }}
                fill="#b5b5b5"
              />
            </svg>
          </Link>
          <Link to="/search" className="nav-link">
            ...
            >
              <path
                ...
                style={{ stroke: location.pathname == "/search" && "#fe9063" }}
              />
              <path
          ...
          <Link to="/newpost" className="nav-link add-post">
          ...
          <Link to="/chat" className="nav-link">
            ...
            >
              <path
                ...
                style={{ fill: location.pathname == "/chat" && "#fe9063" }}
              />
            </svg>
          </Link>
          <Link to="/profile" className="nav-link">
            ...
            >
              <path
                ...
                style={{ fill: location.pathname == "/profile" && "#fe9063" }}
              />
            </svg>
          </Link>
        </div>
