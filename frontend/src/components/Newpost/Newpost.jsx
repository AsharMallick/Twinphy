...
import { newpost } from "../../state/actions/post";
            ...
            <div className="offcanvas-body small">
              ...
              <ul className="list-style-1">
                <li>
                  ...
                  conditions or disclaimers provided in the pages of our
                  website. Please review the Terms carefully. The Terms apply to
                  all users of our website, including without limitation.
                </li>
                <li>
                  The Terms are to be read together by you with any terms,
                  conditions or disclaimers provided in the pages of our
              ...
              <ul className="list-style-1">
                <li>
                  ...
                  would constitute a civil or criminal offence or violate any
                  law.
                </li>
              </ul>
              <h6 className="title">Use of our Website</h6>
